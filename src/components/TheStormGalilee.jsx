...
import the_storm_galilee_small from '../assets/the-storm-on-the-sea-of-galilee/hero-small.jpg'
import the_storm_galilee_large from '../assets/the-storm-on-the-sea-of-galilee/hero-large.jpg'
import the_storm_galilee_artist from '../assets/the-storm-on-the-sea-of-galilee/artist.jpg'

const TheStormGalilee = () => {
    ...
    <div>
      <main className="w-[85%] mx-auto mt-25 sm:mt-30 mb-15 flex flex-col lg:flex-row sm:items-center gap-5 sm:gap-20">
        <section className="sm:flex sm:items-start">
          <div className="relative z-1 sm:w-[100%]">
            <picture onClick={openModal}>
              <source media="(min-width: 640px)" srcSet={the_storm_galilee_large} />
              <img
                className="cursor-pointer"
                src={the_storm_galilee_small}
        ...
        <section className="flex flex-col gap-20 sm:w-[70%] sm:mx-auto relative">
          ...
          <p className="text-xs text-grey400 leading-6 font-bold px-3.5 sm:px-6.5 lg:px-3">
...
export default TheStormGalilee;
