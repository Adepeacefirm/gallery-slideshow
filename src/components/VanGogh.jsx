...
import van_gogh_small from '../assets/van-gogh-self-portrait/hero-small.jpg'
import van_gogh_large from '../assets/van-gogh-self-portrait/hero-large.jpg'
import van_gogh_artist from '../assets/van-gogh-self-portrait/artist.jpg'
    ...
    <div>
      <main className="w-[85%] mx-auto mt-25 sm:mt-30 mb-15 flex flex-col lg:flex-row sm:items-center gap-5 sm:gap-20">
        ...
        <section className="flex flex-col gap-20 sm:w-[70%] sm:mx-auto relative">
          ...
          <p className="text-xs text-grey400 leading-6 font-bold px-3.5 sm:px-6.5 lg:px-6">
