...
import the_night_cafe_small from "../assets/the-night-cafe/hero-small.jpg";
import the_night_cafe_large from "../assets/the-night-cafe/hero-large.jpg";
import the_night_cafe_artist from "../assets/the-night-cafe/artist.jpg";
    ...
    <div>
      <main className="w-[85%] mx-auto mt-25 sm:mt-30 mb-15 flex flex-col lg:flex-row sm:items-center gap-5 sm:gap-20">
          ...
          <div className="relative z-1 sm:w-[100%]">
            <picture onClick={openModal}>
              <source
                ...
                srcSet={the_night_cafe_large}
              />
              <img
                className="cursor-pointer"
                src={the_night_cafe_small}
        ...
        <section className="flex flex-col gap-20 sm:w-[70%] sm:mx-auto relative">
          ...
          <p className="text-xs text-grey400 leading-6 font-bold px-3.5 sm:px-6.5 lg:px-9">
