...
import the_basket_apples_small from '../assets/the-basket-of-apples/hero-small.jpg'
import the_basket_apples_large from '../assets/the-basket-of-apples/hero-large.jpg'
import the_basket_apples_artist from '../assets/the-basket-of-apples/artist.jpg'


const TheBasketApples = () => {
    ...
    <div>
      <main className="w-[85%] mx-auto mt-25 sm:mt-30 mb-15 flex flex-col lg:flex-row sm:items-center gap-5 sm:gap-20">
        <section className="sm:flex sm:items-start">
          <div className="relative z-1 sm:w-[100%]">
            <picture onClick={openModal}>
              <source
                ...
                srcSet={the_basket_apples_large}
              />
              <img
                className="cursor-pointer"
                src={the_basket_apples_small}
          ...
          <div className="w-[80%] sm:w-[50%] flex flex-col -mt-10 sm:-mt-0 lg:gap-70 relative z-50 bg-white">
            <div className="bg-white p-5 sm:px-10 sm:pt-0 sm:-ml-50 lg:-ml-20 sm:-mt-1">
              ...
              <p className="text-xs sm:my-6 text-grey400">Paul Cezanne</p>
            </div>
            <img
              className="w-[20%] sm:w-[55%] ml-2 sm:ml-8"
              src={the_basket_apples_artist}
              alt="starry artist"
            />
          </div>
        </section>
        <section className="flex flex-col gap-20 sm:w-[70%] sm:mx-auto relative">
          ...
          <p className="text-xs text-grey400 leading-6 font-bold px-3.5 sm:px-6.5 lg:px-7">
...
export default TheBasketApples;
