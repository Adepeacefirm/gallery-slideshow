...
import the_boy_red_large from "../assets/the-boy-in-the-red-vest/hero-large.jpg";
import the_boy_red_small from "../assets/the-boy-in-the-red-vest/hero-small.jpg";
import the_boy_red_artist from "../assets/the-boy-in-the-red-vest/artist.jpg";
    ...
    <div>
      <main className="w-[85%] mx-auto mt-25 sm:mt-30 mb-15 flex flex-col lg:flex-row sm:items-center gap-5 sm:gap-20">
        <section className="sm:flex sm:items-start">
          <div className="relative z-1 sm:w-[100%]">
            <picture onClick={openModal}>
              <source media="(min-width: 640px)" srcSet={the_boy_red_large} />
              <img
                className="cursor-pointer"
                src={the_boy_red_small}
          ...
          <div className="w-[80%] sm:w-[50%] flex flex-col -mt-10 sm:-mt-0 lg:gap-70 relative z-50 bg-white">
            <div className="bg-white p-5 sm:px-10 sm:pt-0 sm:-ml-50 lg:-ml-20 sm:-mt-1">
              ...
              <p className="text-xs sm:my-6 text-grey400">Edward Hopper</p>
            </div>
            <img
              className="w-[20%] sm:w-[55%] ml-2 sm:ml-8"
              src={the_boy_red_artist}
              alt="starry artist"
            />
          </div>
        </section>
        <section className="flex flex-col gap-20 sm:w-[70%] sm:mx-auto relative">
          ...
          <p className="text-xs text-grey400 leading-6 font-bold px-4 sm:px-6.5 lg:px-7">
            Cézanne painted four oil portraits of this Italian boy in the red
            vest, all in different poses, which allowed him to study the
            relationship between the figure and space. The most famous of the
            four, and the one commonly referred to by this title, is the one
            which depicts the boy in a melancholic seated pose with his elbow on
            a table and his head cradled in his hand. It is currently held in
            Zürich, Switzerland. The other three portraits, of different poses,
            are in museums in the US.
          </p>
